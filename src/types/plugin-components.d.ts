...
declare module "@proxycast/plugin-components" {
  ...
  // Claude 专用组件
  export const ClaudeFormStandalone: ComponentType<{
    authType: string;
    onSuccess: () => void;
    onCancel: () => void;
  }>;
  ...
  export const Terminal: ComponentType<{ className?: string }>;
  export const Building: ComponentType<{ className?: string }>;
  export const Lock: ComponentType<{ className?: string }>;
  export const Cloud: ComponentType<{ className?: string }>;
  export const Server: ComponentType<{ className?: string }>;
